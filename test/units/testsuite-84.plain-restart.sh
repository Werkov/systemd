...
active_inst1="$(systemctl show -P Following testservice-84-foo.service)"
[[ "$active_inst1" =~ testservice-84-foo#[^.]*.service ]]
systemctl is-active "$active_inst1"

logger "MARK restart"
systemctl restart testservice-84-foo.service
# check two gens exist
active_inst2="$(systemctl show -P Following testservice-84-foo.service)"
...
active_inst3="$(systemctl show -P Following testservice-84-foo.service)"
