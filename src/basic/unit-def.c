...
static const char* const service_state_table[_SERVICE_STATE_MAX] = {
        ...
        [SERVICE_PASSIVATE]                  = "passivate",
        [SERVICE_RUNNING_PASSIVE]            = "running-passive",
        [SERVICE_STOP]                       = "stop",
...
static const char* const unit_dependency_table[_UNIT_DEPENDENCY_MAX] = {
        ...
        [UNIT_PROPAGATES_RAW_STOP_TO] = "PropagatesRawStopTo",
        [UNIT_RAW_STOP_PROPAGATED_FROM]="RawStopPropagatedFrom",
