...
typedef enum CGroupController {
        ...
        CGROUP_CONTROLLER_MISCONTROLLER,
...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_MISC = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_MISCONTROLLER),
        ...
        CGROUP_MASK_V2 = CGROUP_MASK_CPU|CGROUP_MASK_CPUSET|CGROUP_MASK_IO|CGROUP_MASK_MEMORY|CGROUP_MASK_PIDS|CGROUP_MASK_MISC,
